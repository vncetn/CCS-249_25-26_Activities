...
def eliza_response(user_input):
    ...
    patterns = [
        ...
        (r"I want to know the reasons why I feel(.*)", "What made you feel {0}?"),
        (r"I am feeling (.*)", "What is making you feel {0}?"),
        (r"My feelings towards my crush are (.*)", "Why do you think that your feelings are {0}?"),6y
        (r"You don't understand (.*)", "Why do you think I don't understand {0}?"),
        (r"I can't focus on my (.*)", "What is bothering you from focusing on your {0}?")
    ]
